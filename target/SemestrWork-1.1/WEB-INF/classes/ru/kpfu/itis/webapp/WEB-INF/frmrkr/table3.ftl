    ...
    <div class="events">
        <ul>
            <li class="events-group">
                ...
                <ul>
                    <li class="single-event" data-start="08:30" data-end="10:00"  data-event="event-1">
                        <a href="#0">
                            <em class="event-name">Physics</em>
                        </a>
                    </li>

                    <li class="single-event" data-start="11:00" data-end="12:30" data-event="event-2">
                        <a href="#0">
                            <em class="event-name">Geometry</em>
                        </a>
                    </li>
            ...
            <li class="events-group">
                ...
                <ul>
                    ...
                    <li class="single-event" data-start="13:30" data-end="15:00" data-event="event-1">
                        <a href="#0">
                            <em class="event-name">Materials</em>
                        </a>
                    </li>

                    <li class="single-event" data-start="15:45" data-end="17.15"  data-event="event-3">
                        <a href="#0">
                            <em class="event-name">Philosophy</em>
                        </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="events-group">
                ...
                <ul>
                    ...
                    <li class="single-event" data-start="12:00" data-end="13:25"  data-event="event-2">
                        <a href="#0">
                            <em class="event-name">History</em>
                        </a>
                    </li>
            ...
            <li class="events-group">
                ...
                <ul>
                    <li class="single-event" data-start="10:30" data-end="12:00" data-event="event-2">
                        <a href="#0">
                            <em class="event-name">Physical Culture</em>
                        </a>
                    </li>
