    ...
    <div class="events">
        <ul>
            ...
            <li class="events-group">
                ...
                <ul>
                    ...
                    <li class="single-event" data-start="13:30" data-end="15:00" data-event="event-1">
                        <a href="#0">
                            <em class="event-name">Computer Graphics</em>
                        </a>
                    </li>
            ...
            <li class="events-group">
                ...
                <ul>
                    <li class="single-event" data-start="11:00" data-end="12:00" data-event="event-2">
                        <a href="#0">
                            <em class="event-name">Computer Graphics</em>
                        </a>
                    </li>
                    ...
                    <li class="single-event" data-start="14:45" data-end="16:45" data-event="event-3">
                        <a href="#0">
                            <em class="event-name">Chemistry</em>
                        </a>
                    </li>
